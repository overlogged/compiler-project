...
$(BASE): bin/main.o bin/parser.o bin/lexer.o bin/driver.o bin/utils.o bin/syntax_tree.o bin/function.o bin/codegen_llvm.o bin/type.o bin/syntax_expr.o bin/codegen_llvm_type.o
	$(CXX) -o $@ $^ $(LDFLAGS)
